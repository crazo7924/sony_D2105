...
void SVGFEImageElement::requestImageResource()
{
    ...
    ResourceRequest request(ownerDocument()->completeURL(href()));    //SOMC KK PATCH Patches_w16.5
    m_cachedImage = ownerDocument()->cachedResourceLoader()->requestImage(request);    //SOMC KK PATCH Patches_w16.5
