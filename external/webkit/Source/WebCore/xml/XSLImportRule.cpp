...
#include "Document.h"    //SOMC KK PATCH Patches_w16.5
...
void XSLImportRule::loadSheet()
{
    ...
    ResourceRequest request(cachedResourceLoader->document()->completeURL(absHref));    //SOMC KK PATCH Patches_w16.5
    m_cachedSheet = cachedResourceLoader->requestXSLStyleSheet(request);    //SOMC KK PATCH Patches_w16.5
