...
#include "ResourceRequest.h"    //SOMC KK PATCH Patches_w16.5
...
class SecurityOrigin;    //SOMC KK PATCH Patches_w16.5
...
public:
    ...
    CachedResource(const ResourceRequest&, Type);    //SOMC KK PATCH Patches_w16.5
    ...
    {
#if ENABLE(LINK_PREFETCH)
        return type() == LinkPrefetch || type() == LinkPrerender || type() == LinkSubresource;    //SOMC KK PATCH Patches_w16.5
#else
        return false;
#endif
    }
    ...
    bool passesAccessControlCheck(SecurityOrigin*);    //SOMC KK PATCH Patches_w16.5
...
protected:
    ...
    ResourceRequest m_resourceRequest;    //SOMC KK PATCH Patches_w16.5
    String m_accept;
