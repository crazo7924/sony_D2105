...
public:
            ...
            maxArraySize(0), arrayInformationType(0), structure(0), structureSize(0), deepestStructNesting(0), fieldName(0), mangled(0), typeName(0)
    {
        if (p.userDef) {
            ...
            computeDeepestStructNesting();    //SOMC KK PATCH Patches_w16.5
        }
    }
    ...
    void copyType(const TType& copyOf, TStructureMap& remapper)
    {
        ...
        deepestStructNesting = copyOf.deepestStructNesting;    //SOMC KK PATCH Patches_w16.5
    ...
    void setStruct(TTypeList* s) { structure = s; computeDeepestStructNesting(); }    //SOMC KK PATCH Patches_w16.5
...
protected:
    ...
    void computeDeepestStructNesting();    //SOMC KK PATCH Patches_w16.5
    ...
    int deepestStructNesting;    //SOMC KK PATCH Patches_w16.5
