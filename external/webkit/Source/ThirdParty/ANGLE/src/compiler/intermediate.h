...
protected:
    ...
    bool unrollFlag; // Whether the loop should be unrolled or not.    //SOMC KK PATCH Patches_w16.5
};
...
public:
    ...
    TIntermSymbol(int i, const TString& sym, const TType& t) : 
            TIntermTyped(t), id(i)  { symbol = sym; originalSymbol = sym; }     //SOMC KK PATCH Patches_w16.5
...
protected:
    int id;
    TString symbol;
    TString originalSymbol;    //SOMC KK PATCH Patches_w16.5
};
...
public:
    ...
    virtual ~TIntermTraverser() {}    //SOMC KK PATCH Patches_w16.5
