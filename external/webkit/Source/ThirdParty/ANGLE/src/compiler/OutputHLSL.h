...
class OutputHLSL : public TIntermTraverser
{
  public:
    ...
    static TString decorateUniform(const TString &string, const TType &type);    //SOMC KK PATCH Patches_w16.5
  ...
  protected:
    ...
    void outputLineDirective(int line);    //SOMC KK PATCH Patches_w16.5
    ...
    bool mUsesTexture2DLod;    //SOMC KK PATCH Patches_w16.5
    bool mUsesTexture2DProj;
    bool mUsesTexture2DProj_bias;
    bool mUsesTexture2DProjLod;    //SOMC KK PATCH Patches_w16.5
    bool mUsesTextureCube;
    bool mUsesTextureCube_bias;
    bool mUsesTextureCubeLod;    //SOMC KK PATCH Patches_w16.5
