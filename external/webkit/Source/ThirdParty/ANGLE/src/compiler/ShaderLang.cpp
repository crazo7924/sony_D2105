...
#include "compiler/preprocessor/length_limits.h"    //SOMC KK PATCH Patches_w16.5
                             ...
                             const ShBuiltInResources* resources)
{
    ...
    TShHandleBase* base = static_cast<TShHandleBase*>(ConstructCompiler(type, spec, output));    //SOMC KK PATCH Patches_w16.5
    TCompiler* compiler = base->getAsCompiler();
    if (compiler == 0)
        return 0;
...
void ShGetInfo(const ShHandle handle, ShShaderInfo pname, int* params)
{
    ...
    case SH_ACTIVE_UNIFORM_MAX_LENGTH:
        *params = 1 + MAX_SYMBOL_NAME_LEN;    //SOMC KK PATCH Patches_w16.5
        break;
