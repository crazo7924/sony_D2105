...
struct TVariableInfo {
    TPersistString name;
    TPersistString mappedName;    //SOMC KK PATCH Patches_w16.5
    ShDataType type;
    int size;
};
...
public:
    ...
    virtual ~CollectAttribsUniforms() {}    //SOMC KK PATCH Patches_w16.5
...
#endif // COMPILER_VARIABLE_INFO_H_     //SOMC KK PATCH Patches_w16.5
