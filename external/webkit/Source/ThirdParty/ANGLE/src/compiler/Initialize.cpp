...
//
//============================================================================
static TString BuiltInFunctionsCommon(const ShBuiltInResources& resources)    //SOMC KK PATCH Patches_w16.5
{
    TString s;
                           ...
                           const ShBuiltInResources& resources)
{
    ...
    case SH_FRAGMENT_SHADER:
        ...
        builtInStrings.push_back(BuiltInFunctionsCommon(resources));    //SOMC KK PATCH Patches_w16.5
                      ...
                      TSymbolTable& symbolTable)
{
    ...
    case SH_FRAGMENT_SHADER: {
            ...
            TType fragData(EbtFloat, EbpMedium, EvqFragData,   4, false, true);    //SOMC KK PATCH Patches_w16.5
