...
#define SH_VERSION 105    //SOMC KK PATCH Patches_w16.5
...
//
COMPILER_EXPORT int ShInitialize();    //SOMC KK PATCH Patches_w16.5
//
// Driver should call this at shutdown.
// If the function succeeds, the return value is nonzero, else zero.
//
COMPILER_EXPORT int ShFinalize();    //SOMC KK PATCH Patches_w16.5
...
//
COMPILER_EXPORT void ShInitBuiltInResources(ShBuiltInResources* resources);    //SOMC KK PATCH Patches_w16.5
...
//                         ShGetActiveUniform().
//
COMPILER_EXPORT int ShCompile(    //SOMC KK PATCH Patches_w16.5
...
COMPILER_EXPORT void ShGetInfo(const ShHandle handle,
                               ShShaderInfo pname,
                               int* params);    //SOMC KK PATCH Patches_w16.5
...
COMPILER_EXPORT void ShGetInfoLog(const ShHandle handle, char* infoLog);    //SOMC KK PATCH Patches_w16.5
...
COMPILER_EXPORT void ShGetObjectCode(const ShHandle handle, char* objCode);    //SOMC KK PATCH Patches_w16.5
